...
describe 'openssh_test::service on ubuntu-12_04' do
  ...
  context 'when using default parameters' do
    ...
    it 'steps into openssh_service and writes log[message for ubuntu-12.04]' do
      expect(ubuntu_12_04_default_stepinto_run).to write_log('Sorry, openssh_service support for ubuntu-12.04 has not yet been implemented.')
    end
  end
end
